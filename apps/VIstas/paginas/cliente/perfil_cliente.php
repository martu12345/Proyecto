    ...
    <div class="perfil-container">
        <div class="perfil-box">
            ...
            <div class="perfil-info" id="contenido-seccion">
                <?php 
                switch ($seccion) {
                    case 'perfil': include $_SERVER['DOCUMENT_ROOT'] . '/Proyecto/apps/vistas/paginas/cliente/perfilsecciones/datos.php'; break;
                    case 'mensajes': include $_SERVER['DOCUMENT_ROOT'] . '/Proyecto/apps/vistas/paginas/cliente/perfilsecciones/mensajes.php'; break;
                    case 'servicios': include $_SERVER['DOCUMENT_ROOT'] . '/Proyecto/apps/vistas/paginas/cliente/perfilsecciones/servicios.php'; break;
                    default: echo "<p>Sección no encontrada</p>";
                }
                ?>
            </div>
        </div>
