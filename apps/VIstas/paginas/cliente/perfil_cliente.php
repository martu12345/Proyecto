        ...
        <div class="perfil-box">
            <div class="perfil-opciones">
                <form id="formFoto" action="" method="POST" enctype="multipart/form-data">
                    <label for="fotoInput" class="foto-circulo">
                        <?php if (!empty($datos['Imagen'])): ?>
                            <img src="<?= htmlspecialchars($datos['Imagen']); ?>" class="foto-perfil" alt="Foto Cliente">
                        <?php else: ?>
                            +
                        <?php endif; ?>
                    </label>
                ...
                <div class="opciones-lista">
                    <a href="?seccion=perfil" class="opcion <?= $seccion == 'perfil' ? 'activa' : ''; ?>">Mi perfil</a>
                    <a href="?seccion=mensajes" class="opcion <?= $seccion == 'mensajes' ? 'activa' : ''; ?>">
                        Mensajes
                    ...
                    <a href="?seccion=servicios" class="opcion <?= $seccion == 'servicios' ? 'activa' : ''; ?>">Servicios</a>
                </div>
            </div>
            ...
            <div class="perfil-info" id="contenido-seccion">
                ...
                switch ($seccion) {
                    case 'perfil':
                        ...
                        break;
                    case 'mensajes':
include $_SERVER['DOCUMENT_ROOT'] . '/Proyecto/apps/controlador/cliente/mostrarmensajescontrolador.php';
                        break;
                    case 'servicios':
