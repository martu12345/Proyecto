        ...
        <div class="perfil-box">
            ...
            <div class="perfil-opciones">
                ...
                <div class="opciones-lista">
                    ...
                    <a href="?seccion=servicios" data-seccion="servicios" class="opcion <?php echo $seccion == 'servicios' ? 'activa' : ''; ?>">
                        Servicios
                        <?php if ($notificacionesAgendados > 0 && $seccion != 'servicios'): ?>
                            <span class="contador-notificaciones-servicios"><?= $notificacionesAgendados ?></span>
                        <?php endif; ?>
                    </a>
                </div>
            </div>
