        ...
        <div class="detalle-servicio">
            ...
            <div class="info-contenedor">
                ...
                <div class="botones-servicio">
                    <?php if ($logueado && $rol === 'cliente' && !empty($empresa)): 
                        $empresaId = $empresa->getIdUsuario();
                        $empresaNombre = htmlspecialchars($empresa->getNombreEmpresa());
                    ?>
                        <!-- Botón de denunciar empresa -->
